...
public:
    ...
    enum NeedleType{DiamonNeedle,TriangleNeedle,FeatherNeedle,AttitudeMeterNeedle,CompassNeedle,PitchNeedle,RollNeedle};//#
...
private:
    ...
    void createPitchNiddle(float r);
    void createRollNiddle(float r);
...
public:
    ...
    QColor getBrush2() const;
    void setBrush2(const QColor &value);

    QColor getBrush3() const;
    void setBrush3(const QColor &brush3);

private:
    QColor m_brush,brush2,m_brush3;
    float mRoll;
    float mPitch;
    float mPitchOffset;
